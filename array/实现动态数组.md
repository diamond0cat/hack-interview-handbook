...
size的物理意义是什么：  size指向下一个可以添加元素的位置，是第一个没有元素的位置
如果size == array.length, 说明数组已经满了
...
public class Array<E> {
    ...
    public E remove(int index){
        ...
        if(size == data.length / 4 && data.length / 2 != 0)  //元素个数变成总容量的1/4时，
...
![20210814113506](https://i.loli.net/2021/08/15/NyJzwne5vqUIBZr.png)
